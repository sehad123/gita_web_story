    ...
    <section className="relative overflow-hidden px-4 py-12 bg-[#f5f0e1] text-gray-800">
      ...
      <motion.div className="relative max-w-4xl mx-auto space-y-6" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
        ...
        <div className="flex justify-center">
          <img src="/img/Hasil/Validasi simulasi/validasi simulasi.png" alt="Tabel Uji Akurasi" className="rounded-lg shadow-lg border-2 border-[#a68a64] max-w-full object-contain" />
        </div>

        <p className="text-justify bg-[#f9f6ef]/80 p-4 rounded-lg shadow-inner text-[#5c4b3b] font-serif">
